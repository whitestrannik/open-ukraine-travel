...
export default function ChernihivEnglishNew() {
  const { lang } = useI18n()
  
  React.useEffect(() => {
    // Force cache refresh
    document.title = "Chernihiv - Ancient Capital of Rus (EN) - " + Date.now();
        ...
        <div className="max-w-6xl mx-auto px-4">
          <nav className="flex items-center space-x-2 text-sm text-[#B0B3BA]">
            ...
            <div className="flex items-center space-x-2 ml-4">
              <Link 
                to={lang === 'uk' ? '/explore/gems/chernihiv' : '/explore/gems/chernihiv'}
