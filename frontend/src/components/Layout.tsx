      ...
      <header className="sticky top-0 z-50 border-b bg-white/95 backdrop-blur-sm shadow-sm">
        <div className="mx-auto max-w-6xl flex items-center justify-between p-4">
          <Link to="/" className="flex items-center gap-3">
            <img src="/logo/Logo.png" alt="Open Ukraine" className="h-8 w-auto" />
            <span className="font-bold text-xl text-[#22242A]">Open Ukraine</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-6">
            <NavLink 
              to="/explore" 
              className={({ isActive }) => 
                `font-medium transition-colors hover:text-[#1F5FA0] ${
                  isActive ? 'text-[#1F5FA0] border-b-2 border-[#1F5FA0]' : 'text-[#22242A]'
                }`
              }
            >
              {t('nav.explore')}
